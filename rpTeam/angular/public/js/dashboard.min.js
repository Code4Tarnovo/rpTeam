...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html",controller:"MapCtrl"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"})}]);
...
function MapCtrl(a,e){a.getWidth=function(){return window.innerWidth};var t=L.map("map").setView([43.082222,25.631667],14);L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpandmbXliNDBjZWd2M2x6bDk3c2ZtOTkifQ._QA7i5Mpkd_m30IGElHziw",{maxZoom:18,attribution:'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="http://mapbox.com">Mapbox</a>',id:"mapbox.streets"}).addTo(t);var o=firebase.database().ref().child("buses"),i=43.082222,r=25.631667,n={};o.on("child_changed",function(a){i=a.val().longitude,r=a.val().latitude,id=a.key;var e=n[id],o=new L.LatLng(r,i);e.setLatLng(o).addTo(t)}),o.on("child_added",function(a){var e=a.val().latitude,o=a.val().longitude,i=a.key,r=L.marker([o,e]).addTo(t);n[i]=r}),o.on("child_removed",function(a){var e=a.key,o=n[e];t.removeLayer(o)})}angular.module("RDash").controller("MapCtrl",["$scope",MapCtrl]);
